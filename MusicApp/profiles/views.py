...
# def home_view(request: HttpRequest) -> HttpResponse: # function-based view
#     profile = get_profile()
#
#     context = {
#         "form": ProfileForm
...
class HomeView(View):# class-based view
    ...
    def post(self, request) -> HttpResponse:
        ...
        return render(request, 'profiles/home-no-profile.html', {"form": form}) # to return the form with its errors

class ProfileDetailView(DetailView): # this could also be a TemplateView
